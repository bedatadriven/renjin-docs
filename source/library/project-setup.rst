...
You can use ``RELEASE`` instead of ``0.8.2299`` in the project file to use the
...
a single JAR file called:
    ...
    renjin-script-engine-0.8.2299-jar-with-dependencies.jar
...
.. code-block:: xml
    ...
    <module xmlns="urn:jboss:module:1.1" name="org.renjin">
      <resources>
        <resource-root path="renjin-script-engine-0.8.2299-jar-with-dependencies.jar"/>
      </resources>
      <dependencies>

...
You can use ``RELEASE`` instead of ``0.8.2553`` in the project file to use the
...
.. code-block:: groovy
    ...
    dependencies {
      compile "org.renjin:renjin-script-engine:0.8.2553";
    }
...
.. code-block:: scala
    ...
    lazy val root = (project in file(".")).
      settings(
        ...
        version := "1.0",
        scalaVersion := "2.10.6",
        libraryDependencies += "org.renjin" % "renjin-script-engine" % "0.8.2553"
      )
...
a single JAR file called:
    ...
    renjin-script-engine-0.8.2553-jar-with-dependencies.jar
...
.. code-block:: xml
    ...
    <module xmlns="urn:jboss:module:1.1" name="org.renjin">
      <resources>
        <resource-root path="renjin-script-engine-0.8.2553-jar-with-dependencies.jar"/>
      </resources>
      <dependencies>

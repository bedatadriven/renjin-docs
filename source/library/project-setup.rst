...
You can use ``RELEASE`` instead of ``0.9.2620`` in the project file to use the
...
.. code-block:: groovy
    ...
    dependencies {
      compile "org.renjin:renjin-script-engine:0.9.2620";
    }
...
a single JAR file called:
    ...
    renjin-script-engine-0.9.2620-jar-with-dependencies.jar
...
.. code-block:: xml
    ...
    <module xmlns="urn:jboss:module:1.1" name="org.renjin">
      <resources>
        <resource-root path="renjin-script-engine-0.9.2620-jar-with-dependencies.jar"/>
      </resources>
      <dependencies>
